...
public class Main extends javax.swing.JFrame {
    ...
    private void setLevel(int level) {
        ...
        if(level < TOP_LEVEL) {
            ...
            String nombreFichero = "sudoku_levels.txt";
            ...
            try {
               ...
               int numLinea = 1;
               //Repetir mientras no se llegue al nivel elegido.
               while(numLinea < level)
               { 
     ...
     private void loadProperties() {
        try {
            properties.load(new FileReader("sudoku.properties"));
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        try {
            ...
            properties.setProperty("last_level", String.valueOf(jComboBox1.getSelectedItem()));
            properties.store(new BufferedWriter(new FileWriter("sudoku.properties")), " ");
        } catch (IOException ex) {
